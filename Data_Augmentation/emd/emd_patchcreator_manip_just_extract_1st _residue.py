...
from imageio import imwrite
from PIL import Image
imreadpath = 'E:\\RR\\5_patches_512_manip_dataset\\gamma_0.8\\'
imwritepath = 'E:\\RR\\5_patches_512_manip_dataset_emd\\gamma_0.8\\'
...
model = ['htc', 'iphone4', 'iphone6', 'lg', 
         'motodroid']
#manipulations = ['gamma_0.8','gamma_1.2','quality70','quality90','resize_0.5','resize_0.8','resize_1.5','resize_2.0']
