...
core_dir =  "E:\\RR\\SP_Kaggle_5_patches_512_dataset\\*"
...
train_dir, train_label, val_dir, val_label, test_dir, test_label = [],[],[],[],[],[]

split_ratio = np.array([0.7, 0.2, 0.1]); #train, valid, test; sum must be 1.0
...
#model_final = model.get_layer(index = -2).output
